...
other = {
	...
	# If you already knew Linux commands, then you would likely have skipped these tutorials.  Did you already know enough Linux to skip them?  Answer True if so, False if you went through the tutorials.  The answer to this will not change your grade at all.
