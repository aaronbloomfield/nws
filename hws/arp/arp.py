...
other = {
	...
	# Were you able to get the ARP spoof example (the first one) working? This
	# should be either True or False.
	'able_to_get_arp_spoof_working': None,

	# Were you able to get the MITM example working?  This should be either
	# True or False.
	'able_to_get_mitm_working': None,
...
sanity_checks = {
	...
	# Does your arpDetector.py take in the network interface as the 1st
	# (and only) comand line parameter?
	'interface_as_command_line_parameter': False,
