# Submission information for the DNS Spoofing HW
# https://aaronbloomfield.github.io/nws/hws/dnsspoof/

# The filename of this file must be 'dnsspoof.py', else the submission verification
...
sanity_checks = {
	...
	# Does your `dns_spoof_host.py` file listen to the `eth0` interface
	# on *gateway*?
	'dns_spoof_listens_to_eth0': False,

	# Do your two DNS poisoning programs (`dns_poison.py` and
	# `dns_poison_ns.py`) listen to the eth2 interface on *gateway*?
	'dns_poison_listens_to_eth2': False,
